          ...
          {leadership.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className={`cursor-pointer overflow-hidden border-2 border-ink/15 bg-white shadow-[4px_4px_0_0_rgba(10,10,10,0.08)] transition-shadow hover:shadow-[6px_6px_0_0_rgba(10,10,10,0.12)] ${rotations[i % rotations.length]}`}
